...
if ($db->userExists($email, "businessity_ama")) {
    ...
    $db->insertUser("businessity_ama", $details);
        // Send SMS
        $notify->viaSMS("Businessity", "Dear {$name}, thank you for sending in your question. You will reached via SMS with further details about the Live Session. Thank you.", $phone);
